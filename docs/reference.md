...
The public API lives at the module root (`github.com/go-ruby-connection-pool/connection-pool`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `connection-pool`, while the surface follows
...
```go
import "github.com/go-ruby-connection-pool/connection-pool"
```
...
- **[pkg.go.dev/github.com/go-ruby-connection-pool/connection-pool](https://pkg.go.dev/github.com/go-ruby-connection-pool/connection-pool)**

The module's [README](https://github.com/go-ruby-connection-pool/connection-pool#readme) carries worked
