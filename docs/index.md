# go-ruby-connection-pool documentation

**Pure-Go, MRI-4.0.5-faithful Ruby connection-pool (no cgo)**

`go-ruby-connection-pool/connection-pool` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `connection-pool`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-connection-pool/connection-pool`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `connection-pool`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`connection-pool`](https://github.com/go-ruby-connection-pool/connection-pool) | the library — Ruby's `connection-pool` in pure Go |
| [`docs`](https://github.com/go-ruby-connection-pool/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-connection-pool.github.io`](https://github.com/go-ruby-connection-pool/go-ruby-connection-pool.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-connection-pool/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-connection-pool/connection-pool](https://github.com/go-ruby-connection-pool/connection-pool).
